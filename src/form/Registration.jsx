      ...
      <Box>
        {emp ? (
          <Box>
            ...
            >
              <DialogTitle style={{
                padding: 6, backgroundColor: '#2979ff', display: 'flex', justifyContent: 'center', color: '#FFFFFF', fontWeight: '600',
              }}
              >
                Registration
              </DialogTitle>
              <DialogTitle style={{
                backgroundColor: '#FF0000', display: `${error}`, justifyContent: 'center', color: '#FFFFFF',
              }}
              >
                {errorMsg}
              </DialogTitle>
              <DialogTitle style={{
                backgroundColor: '#008000', display: `${datasubmitDisplay}`, justifyContent: 'center', color: '#FFFFFF',
              }}
              >
                {datasubmit}
              </DialogTitle>
              <DialogContent>
                ...
                <Box sx={{
                  color: ' #000000.', p: 2, borderRadius: '25px', fontSize: '29px',
                }}
                >
                  <Grid container spacing={2}>
                    <Grid item xs={12}>
                      <form>
                        ...
                        <audio id="my-audio" controls style={{ display: 'block' }} />
              ...
              <DialogActions>
                <Button variant="contained" style={{ backgroundColor: '#FFFFFF', color: '#000000' }} onClick={cancelButton}>Cancel</Button>
                <Button variant="contained" style={{ backgroundColor: '#6d6d6d', color: '#FFFFFF' }} onClick={submitButton}>Submit</Button>
              </DialogActions>
            </Dialog>
          </Box>
        ) : <PropagateLoader color="#d6364e" size="20" style={propagate} />}
